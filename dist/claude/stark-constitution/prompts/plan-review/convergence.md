# Convergence review — did the last edits break the plan?

You are reviewing the FINAL DELTA of an already-reviewed execution plan. Every
...
2. **Broken cross-reference** — the edit renamed, removed, or renumbered
   something (a section, task id, file path, interface, phase) that
