...
1. **Does the spec declare a version scope** (e.g., "V1 scope", "Out of scope for v1")? If yes, only flag items within that stated scope. Items the spec explicitly defers to Phase 2 or future work are NOT scope issues — they are intentional deferrals.
