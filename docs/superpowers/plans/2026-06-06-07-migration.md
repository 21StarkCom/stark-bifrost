...
- `skill/<name>/SKILL.md` frontmatter keys seen in the live repo:
  ...
  → **add (defaulted):** version `0.1.0`, tags `[]`, category, maturity `beta`, owner `Evinced`, runtimes `[claude]`.
